...
def lista():
    ...
    c = request.args.get("c", default=None, type=str)
    ...
    return render_template("produto/lista.jinja", rset_page=rset_page, page=page,
                           pp=pp, q=q, c=str(c), a=a, categorias=Categoria.get_tuples_id_atributo(),
...
def remove(id_produto):
    ...
    return render_template("produto/delete.jinja", produto=produto, title="Remover produto")
